    ...
    {#if $page.url.pathname !== '/'}
      <div class='mr-2 ml-1'>
        <a href='/'
          ...
          <div class='absolute inset-0 rounded-xl bg-linear-to-br from-primary/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300'></div>
