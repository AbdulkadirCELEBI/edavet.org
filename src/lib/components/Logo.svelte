...
>
  ...
  <div class='relative w-12 h-12 flex shrink-0 items-center justify-center rounded-[12px] shadow-[0_8px_20px_rgba(251,191,36,0.3)] bg-linear-to-br from-[#FFE135] via-amber-400 to-amber-500 overflow-hidden border border-amber-300'>

    <!-- Parlama Efekti (Şerit şeklide geçen işık) -->
    <div class='absolute top-0 -inset-full h-full w-1/2 z-0 block transform -skew-x-12 bg-linear-to-r from-transparent via-white/50 to-transparent group-hover:animate-[shimmer_1.5s_infinite]'></div>
  ...
  <div class='flex flex-col justify-center'>
    ...
    <div class='flex items-baseline relative leading-none'>
      ...
      <span class='text-lg lg:text-xl font-bold tracking-tight bg-linear-to-r from-amber-400 to-amber-600 bg-clip-text text-transparent ml-0.5'>
        .org
      </span>
    </div>
  </div>
